...
```bash
curl -X POST https://api.peeap.com/webhooks/wh_abc123/test \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl https://api.peeap.com/webhooks \
  -H "Authorization: Bearer YOUR_TOKEN"
```
...
```bash
curl -X PATCH https://api.peeap.com/webhooks/wh_abc123 \
  -H "Authorization: Bearer YOUR_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X DELETE https://api.peeap.com/webhooks/wh_abc123 \
  -H "Authorization: Bearer YOUR_TOKEN"
```
